using BizSecureDemo22180087.ViewModels;
using BizSecureDemo22180087.Data;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;
using System.Security.Claims;
namespace BizSecureDemo22180087.Controllers
{
    [Authorize]
    public class ReplayDemoController : Controller
    {
        ...
        public IActionResult Withdraw(ReplayDemoVm vm)
        {
            ...
            Console.WriteLine($"Incoming nonce: '{vm.Nonce}'; usedNonces count: {_usedNonces.Count}; contains: {_usedNonces.Contains(vm.Nonce)}");
